...
class LanguageModelingDataset:
    ...
    def __init__(self, train_data_path, valid_data_path, test_data_path, tokenizer, batch_size, sequence_length):
    ...
    def create_vocab(self):
        ...
        self.vocab = vocab.build_vocab_from_iterator(tokenized_data)
